...
python test_new.py --config_file configs/pretrain.yml --model_path '../logs/pretrain/'$model'/coco-flir/flir/transformer_best_model.pth' MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'flir' \
